    ...
    <div className="p-6 lg:p-8 max-w-[1400px] mx-auto space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
        ...
        <StatsCard
          ...
          tooltip={
            !isTechUser
              ? "Ce taux représente le pourcentage de tickets résolus avant la deadline par l'équipe technique uniquement (Calcul : Tickets dans les temps / Total tickets résolus)."
              : "Ce taux représente votre pourcentage de tickets résolus avant la deadline par rapport à votre volume total."
          }
        />
      </div>
              ...
              <div className="flex flex-wrap justify-center gap-x-4 gap-y-2 mt-4 max-h-[80px] overflow-y-auto custom-scrollbar">
                {pieData.map((c: any, i: number) => (
                  ...
                  >
                    ...
                    />
                    <span className="text-[hsl(var(--foreground))] opacity-80">
                      {c.name}{" "}
